...
public:
    ...
    {
        Downloader->setWindowTitle(QApplication::translate("Downloader", "Updater", 0));
        updater_icon->setText(QString());
        downloadLabel->setText(QApplication::translate("Downloader", "Downloading updates", 0));
        timeLabel->setText(QApplication::translate("Downloader", "Time remaining: 0 minutes", 0));
        openButton->setText(QApplication::translate("Downloader", "Open", 0));
        stopButton->setText(QApplication::translate("Downloader", "Stop", 0));
    } // retranslateUi
